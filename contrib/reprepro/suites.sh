...
targets_from() {
       git fetch -q https://github.com/alcideio/moby.git "$1"
...
release_branch=$(git ls-remote --heads https://github.com/alcideio/moby.git | awk -F 'refs/heads/' '$2 ~ /^release/ { print $2 }' | sort -V | tail -1)
