...
import (
	...
	apiserver "github.com/alcideio/moby/api/server"
	"github.com/alcideio/moby/api/server/middleware"
	"github.com/alcideio/moby/api/server/router"
	"github.com/alcideio/moby/api/server/router/build"
	checkpointrouter "github.com/alcideio/moby/api/server/router/checkpoint"
	"github.com/alcideio/moby/api/server/router/container"
	"github.com/alcideio/moby/api/server/router/image"
	"github.com/alcideio/moby/api/server/router/network"
	pluginrouter "github.com/alcideio/moby/api/server/router/plugin"
	swarmrouter "github.com/alcideio/moby/api/server/router/swarm"
	systemrouter "github.com/alcideio/moby/api/server/router/system"
	"github.com/alcideio/moby/api/server/router/volume"
	"github.com/alcideio/moby/builder/dockerfile"
	...
	dopts "github.com/alcideio/moby/opts"
	"github.com/alcideio/moby/pkg/authorization"
	"github.com/alcideio/moby/pkg/jsonlog"
	"github.com/alcideio/moby/pkg/listeners"
	"github.com/alcideio/moby/pkg/pidfile"
	"github.com/alcideio/moby/pkg/plugingetter"
	"github.com/alcideio/moby/pkg/signal"
	"github.com/alcideio/moby/pkg/system"
	"github.com/alcideio/moby/plugin"
