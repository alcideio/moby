...
import (
	...
	"github.com/alcideio/moby/daemon/discovery"
	"github.com/alcideio/moby/daemon/events"
	"github.com/alcideio/moby/daemon/exec"
	"github.com/alcideio/moby/daemon/logger"
	// register graph drivers
	_ "github.com/alcideio/moby/daemon/graphdriver/register"
	"github.com/alcideio/moby/daemon/initlayer"
	"github.com/alcideio/moby/daemon/stats"
	dmetadata "github.com/alcideio/moby/distribution/metadata"
	"github.com/alcideio/moby/distribution/xfer"
...
func (daemon *Daemon) restore() error {
	...
	for id, c := range containers {
		...
		// Fixes https://github.com/alcideio/moby/issues/22536
