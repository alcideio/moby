...
func (s *DockerSuite) TestRunNoDupVolumes(c *check.C) {
	...
	// Test for https://github.com/alcideio/moby/issues/22093
	volumename1 := "test1"
	volumename2 := "test2"
...
// https://github.com/alcideio/moby/issues/12148
...
// Regression test for https://github.com/alcideio/moby/issues/8259
...
func (s *DockerSuite) TestRunWithTooSmallMemoryLimit(c *check.C) {
	...
	// https://github.com/alcideio/moby/blob/v1.5.0/daemon/create.go#L22
...
// https://github.com/alcideio/moby/pull/14498
